...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(5, _translate("MainWindow", "CADJPY"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(6, _translate("MainWindow", "CHFJPY"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(7, _translate("MainWindow", "EURAUD"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(8, _translate("MainWindow", "EURCAD"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(9, _translate("MainWindow", "EURCHF"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(10, _translate("MainWindow", "EURGBP"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(11, _translate("MainWindow", "EURJPY"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(12, _translate("MainWindow", "EURUSD"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(13, _translate("MainWindow", "GBPCAD"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(14, _translate("MainWindow", "GBPCHF"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(15, _translate("MainWindow", "GBPUSD"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(16, _translate("MainWindow", "NZDCAD"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(17, _translate("MainWindow", "USDCHF"))
        self.CURRENCY_PAIRS_COMBOBOX.setItemText(18, _translate("MainWindow", "USDJPY"))
